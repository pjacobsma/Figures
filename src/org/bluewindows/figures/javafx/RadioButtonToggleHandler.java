...
// This handler allows the user to click a selected radio button to un-select it.
public class RadioButtonToggleHandler {

    private boolean selected = false;

    private RadioButton radioButton;

    public RadioButtonToggleHandler(RadioButton radioButton) {
