...
public class MemoCriterion implements SearchCriterion {

	private String searchString;
	
	public MemoCriterion(String searchString) {
	...
	public boolean matches(Transaction transaction) {
		if (transaction.getMemo().toUpperCase().contains(searchString)) return true;
		return false;
	}
