...
public class AmountGreaterThanCriterionTest extends AbstractDomainTest {
	
	@Test
	public void testConstructor() {
		try {
			@SuppressWarnings("unused")
			AmountGreaterThanCriterion criterion = new AmountGreaterThanCriterion(null);
	...
	public void testMatchNullTransAmount() {
		...
		AmountGreaterThanCriterion criterion = new AmountGreaterThanCriterion(new Money("100.00"));
	...
	public void testMatch() {
		...
		criterion = new AmountGreaterThanCriterion(new Money("100.01"));
		assertFalse(criterion.matches(transaction));
		criterion = new AmountGreaterThanCriterion(new Money("100.02"));
		assertFalse(criterion.matches(transaction));
	}
