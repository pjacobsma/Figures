...
public class AmountEqualsCriterionTest extends AbstractDomainTest {
	
	@Test
	public void testConstructor() {
		try {
			@SuppressWarnings("unused")
			AmountEqualsCriterion criterion = new AmountEqualsCriterion(null);
	...
	public void testMatchNullTransAmount() {
		...
		AmountEqualsCriterion criterion = new AmountEqualsCriterion(new Money("100.00"));
	...
	public void testMatch() {
		...
		criterion = new AmountEqualsCriterion(new Money("100.01"));
		assertFalse(criterion.matches(transaction));
	}
