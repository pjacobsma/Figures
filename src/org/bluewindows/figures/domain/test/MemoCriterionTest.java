...
public class MemoCriterionTest extends AbstractDomainTest {
	
	public void testConstructor() throws Exception {
		try {
			new MemoCriterion(null);
	...
	public void testMatch() throws Exception  {
		...
		tran.setMemo("ABCDEFGHI");
		MemoCriterion criterion = new MemoCriterion(searchString);
		assertTrue(criterion.matches(tran));

		searchString = new String("DEF");
		tran = new Transaction();
		tran.setMemo("abcdefghi");
		criterion = new MemoCriterion(searchString);
		assertTrue(criterion.matches(tran));
