...
public class SourceMemoTest extends AbstractDomainTest {

	@Test
	public void testGetSource() {
		SourceOriginalMemo sd = new SourceOriginalMemo();
		Transaction transaction = new Transaction();
		transaction.setOriginalMemo("Test Memo");
		assertEquals("Test Memo", sd.getSource(transaction));
	}
