...
public class SourceLiteralTest extends AbstractDomainTest {
	
	@SuppressWarnings("unused")
	@Test
	public void testConstructor() {
		try {
			SourceLiteral sc = new SourceLiteral(null);
	...
	public void testGetSource() {
		SourceLiteral sc = new SourceLiteral("Literal");
		assertEquals("Literal", sc.getSource(new Transaction()));
	}
